...
export default function page() {
    ...
    <div className=" w-full bg-stone-950  flex flex-col relative z-40 p-0 py-5 md:p-11">
        ...
        <div className="text-xl md:text-xl lg:text-2xl  xl:text-3xl text-white font-bold mb-2 px-11 py-4">Reading Data from Electrical Meters</div>

          <div className="text-2md md:text-2md lg:text-lg  xl:text-xl text-white mb-2 px-11 py-4">Freelance Backend Developer </div>
...
transmission of information to the Front-End.
        ...
        <div className="w-full border-t-2 flex-col sm:flex-col md:flex md:flex-col lg:flex lg:flex-row border-t-orange-300">
        <div className="w-[100%] sm:w-[100%] md:w-full lg:w-1/2 flex flex-col  p-2 md:p-10 "> 
        <div className="text-xl md:text-xl lg:text-2xl  xl:text-3xl text-white font-bold mb-2 px-11 py-4">Reading Data from SCADA System</div>
...
in furnishing vital metering insights to the frontend system.
        ...
        <div className="w-full border-t-2 flex-col sm:flex-col md:flex md:flex-col lg:flex lg:flex-row border-t-orange-300">
        <div className="w-[100%] sm:w-[100%] md:w-full lg:w-1/2 flex flex-col  p-2 md:p-10 "> 
        <div className="text-xl md:text-xl lg:text-2xl  xl:text-3xl text-white font-bold mb-2 px-11 py-4">Analog to RS485 Converter Integration</div>

          <div className="text-2md md:text-2md lg:text-lg  xl:text-xl text-white mb-2 px-11 py-4">Backend Developer </div>
          <div className='text-neutral-400 leading-6 text-md mb-2 w-full md:w-[100%] px-11'>
